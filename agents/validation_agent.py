...
Responsible for analyzing the dataset metadata,
deciding which validation checks should be executed,
and updating the ValidationState.
"""
...
class ValidationAgent(BaseAgent):
    ...
    def run(
        ...
        try:
            ...
            state = self.validation_tool.execute(
